...
window.onload = function init()
{
    ...
    pictureRight = new Picture(gl, new PV(1, 1, 0, true), new PV(1, 0, 0, false), new PV(0, -1, 0, false), 2, 2); // WRONG
...
function render() {
    ...
    var picture2clip = new Mat(); // WRONG
    ...
    var model2picture = new Mat(); // WRONG
