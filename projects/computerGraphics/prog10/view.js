...
window.onload = function init()
{
    ...
    cube2world = Mat.translation(new PV(-0.1,0.1,-1.5,true)).times(Mat.scale(0.3).times(Mat.rotation(1.0,0.3)));
    ...
    function lookAtL () {
        ...
        var clip2projL = new Mat();

        view2clipL = proj2clipL.times(view2proj);
        clip2viewL = proj2view.times(clip2projL);

        var eye = lightP;
        var obj = rotated2world.times(object2rotated.times(new PV(0,0,0,true)));
