    ...
    constructor (gl, nLon, nLat, color) {
        ...
        for (var i = 0; i < this.face_elements.length; i++) {
            ...
            for (var j = 1; j < face.length - 1; j++) {
                ...
                var p0 = this.verts[face[0]];
                var p1 = this.verts[face[j]];
                var p2 = this.verts[face[j + 1]];
    
                var edge1 = p1.minus(p0);
                var edge2 = p2.minus(p0);
        
                var crossProduct = edge1.cross(edge2);
        
                n = n.plus(crossProduct);
            }
