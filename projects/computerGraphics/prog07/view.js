...
window.onload = function init()
{
    ...
    function updateM2C () {
        ...
        eyeP = object2model.times(rotated2object.times(world2rotated.times(new PV(true))));
        //eyeP = world2view.times(rotated2world.times(object2rotated.times(model2object.times(new PV(true)))));
